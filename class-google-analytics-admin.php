...
class Google_Analytics_Admin {
	...
	public $base = '';
	public $text_domain = 'optimal-google-analytics';
		...
		$settings['standard'] = array(
			...
			'fields'      => array(
				array(
					...
					'label'       => __( 'Google Analytics Property ID', $this->text_domain ),
					'description' => __( '', $this->text_domain ),
					'type'        => 'text',
					'default'     => '',
					'placeholder' => __( 'UA-########-#', $this->text_domain )
				),

				array(
					'id'          => 'exclude_users',
					'label'       => __( 'Exclude Roles From Tracking', $this->text_domain ),
					'description' => __( '', $this->text_domain ),
					'type'        => 'checkbox_multi',
					'options'     => array(
				...
				array(
					'id'          => 'disable_tracking',
					'label'       => __( 'Disable Tracking Code', $this->text_domain ),
					'description' => __( '', $this->text_domain ),
					'type'        => 'checkbox',
					'default'     => ''
				)
	...
	public function add_menu_item() {
		add_menu_page( __( 'Google Analytics', $this->text_domain ),
			__( 'Google Analytics', $this->text_domain ), 'manage_options',
	...
	public function add_settings_link( $links ) {
		$settings_link = array(
			'<a href="' . admin_url( 'options-general.php?page=' . $this->base . '_settings' ) . '">' . __( 'Settings', $this->text_domain ) . '</a>');

		//$settings_link = '<a href="options-general.php?page=' . $this->base . '_settings">' . __( 'Settings', $this->text_domain ) . '</a>';
	...
	public function settings_page() {
		...
		$html .= '<h2>' . __( 'Google Analytics', $this->text_domain ) . '</h2>' . "\n";
